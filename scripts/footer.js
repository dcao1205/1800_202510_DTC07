    ...
    <nav class="container p-3">
        <section class="d-flex justify-content-between">
            ...
            <div id="notification-bell" class="d-flex flex-column align-items-center">
                <a id="btn-add" href="view_message.html" class="text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="38" height="38" stroke-width="2"> <path d="M3 7a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-10z"></path> <path d="M3 7l9 6l9 -6"></path> </svg> 
                </a>
